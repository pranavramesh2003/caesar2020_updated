...
message(STATUS "detection: 1 messages, 2 services")

set(MSG_I_FLAGS "-Idetection:/home/pranav/caesar2020/src/detection/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/pranav/caesar2020/src/detection/msg/detection.msg" NAME_WE)
add_custom_target(_detection_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "detection" "/home/pranav/caesar2020/src/detection/msg/detection.msg" ""
)

get_filename_component(_filename "/home/pranav/caesar2020/src/detection/srv/reached.srv" NAME_WE)
add_custom_target(_detection_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "detection" "/home/pranav/caesar2020/src/detection/srv/reached.srv" ""
)

get_filename_component(_filename "/home/pranav/caesar2020/src/detection/srv/arrow.srv" NAME_WE)
add_custom_target(_detection_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "detection" "/home/pranav/caesar2020/src/detection/srv/arrow.srv" ""
)
...
_generate_msg_cpp(detection
  "/home/pranav/caesar2020/src/detection/msg/detection.msg"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Services
_generate_srv_nodejs(detection
  "/home/pranav/caesar2020/src/detection/srv/reached.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/detection
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/detection)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/detection\")")
  # install generated code
  install(
