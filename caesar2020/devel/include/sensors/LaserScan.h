// Generated by gencpp from file sensors/LaserScan.msg
// DO NOT EDIT!


#ifndef SENSORS_MESSAGE_LASERSCAN_H
#define SENSORS_MESSAGE_LASERSCAN_H
...
struct LaserScan_
{
  ...
  typedef boost::shared_ptr< ::sensors::LaserScan_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sensors::LaserScan_<ContainerAllocator> const> ConstPtr;

}; // struct LaserScan_

typedef ::sensors::LaserScan_<std::allocator<void> > LaserScan;

typedef boost::shared_ptr< ::sensors::LaserScan > LaserScanPtr;
typedef boost::shared_ptr< ::sensors::LaserScan const> LaserScanConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sensors::LaserScan_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sensors::LaserScan_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sensors::LaserScan_<ContainerAllocator1> & lhs, const ::sensors::LaserScan_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::sensors::LaserScan_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sensors::LaserScan_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sensors::LaserScan_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sensors::LaserScan_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sensors::LaserScan_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sensors::LaserScan_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sensors::LaserScan_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sensors::LaserScan_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x90c7ef2dc6895d81ULL;
  static const uint64_t static_value2 = 0x024acba2ac42f369ULL;
};

template<class ContainerAllocator>
struct DataType< ::sensors::LaserScan_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sensors::LaserScan_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sensors::LaserScan_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sensors::LaserScan_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sensors::LaserScan_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // SENSORS_MESSAGE_LASERSCAN_H
