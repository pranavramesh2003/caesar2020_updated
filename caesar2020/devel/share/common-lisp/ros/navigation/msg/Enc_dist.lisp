...
(cl:defmethod cl:initialize-instance :after ((m <Enc_dist>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Enc_dist)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name navigation-msg:<Enc_dist> is deprecated: use navigation-msg:Enc_dist instead.")))

(cl:ensure-generic-function 'dist-val :lambda-list '(m))
(cl:defmethod dist-val ((m <Enc_dist>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader navigation-msg:dist-val is deprecated.  Use navigation-msg:dist instead.")
  (dist m))
