...
(cl:defmethod cl:initialize-instance :after ((m <Planner_state>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Planner_state)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name navigation-msg:<Planner_state> is deprecated: use navigation-msg:Planner_state instead.")))
