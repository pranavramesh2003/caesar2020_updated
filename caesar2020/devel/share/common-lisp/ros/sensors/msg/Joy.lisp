...
(cl:defmethod cl:initialize-instance :after ((m <Joy>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Joy)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensors-msg:<Joy> is deprecated: use sensors-msg:Joy instead.")))
...
(cl:defmethod axes-val ((m <Joy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensors-msg:axes-val is deprecated.  Use sensors-msg:axes instead.")
  (axes m))

(cl:ensure-generic-function 'buttons-val :lambda-list '(m))
(cl:defmethod buttons-val ((m <Joy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensors-msg:buttons-val is deprecated.  Use sensors-msg:buttons instead.")
  (buttons m))
